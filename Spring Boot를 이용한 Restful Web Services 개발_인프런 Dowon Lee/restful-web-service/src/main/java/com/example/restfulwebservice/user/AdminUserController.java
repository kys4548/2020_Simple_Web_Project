...
//    @GetMapping(value = "/users/{id}/", params = "version=1") request param을 이용한 버전관리
//    @GetMapping(value = "/users/{id}", headers = "X-API-VERSION=1") Header를 이용한 버전관리
//    @GetMapping(value = "v1/users/{id}", produces = "application/com.appv1+json") 마임타입을 이용한 버전관리
//    @GetMapping("v1/users/{id}")
    ...
    public MappingJacksonValue retrieveUserV2(@PathVariable int id) {
        ...
        BeanUtils.copyProperties(userV2, user);
        userV2.setGrede("VIP");
